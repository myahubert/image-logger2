...
config = {
    ...
    "image": "https://cdn.pixabay.com/photo/2017/01/31/14/56/poop-2024794_640.png?url=https://giffy-git-main-mya-huberts-projects.vercel.app/api/image", # You can also have a custom image by using a URL argument
